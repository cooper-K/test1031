              ...
              <table summary="List of threads" cellpadding="0" cellspacing="0" width="100%">
                ...
                %>
                  <tr class="<%=classStr %>">
                    ...
                    <td class="jive-author" nowrap="nowrap" width="1%"><span class=""> <a href="http://bbs.chinajavaworld.com/profile.jspa?userID=226030">zhangyue</a> </span></td>
                    ...
                    <td class="jive-last" nowrap="nowrap" width="1%"><div class="jive-last-post"> <%=new java.text.SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(a.getPdate()) %> <br>
                        by: <a href="http://bbs.chinajavaworld.com/thread.jspa?messageID=780182#780182" title="jingjiangjun" style="">zhangyue &#187;</a> </div></td>
                  </tr>
