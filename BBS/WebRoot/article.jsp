...
<%@ page import="java.sql.*, com.zhangyue.bbs.*, java.util.*"%>
...
<link rel="alternate" type="application/rss+xml" title="RSS" href="http://localhost：8080/BBS/article.jspa?forumID=20">
...
<br>
  ...
  <table border="0" cellpadding="0" cellspacing="0" width="100%">
    <tbody>
      <tr valign="top">
        <td width="98%"><p class="jive-breadcrumbs">论坛 :伊甸园论坛</p>
          <p class="jive-description"> 探讨人生哲理,大家一起交流 共同提高！谢绝任何形式的广告 </p>
          </td>
      </tr>
    </tbody>
  </table>
    ...
    <table summary="Buttons" border="0" cellpadding="0" cellspacing="0">
      <tbody>
        <tr>
          ...
          <td><a href="index.jsp">论坛首页</a> </td>
         <td class="jive-icon-label"> <a href="articleSearch.jsp"> 搜索帖子</a></td>
        </tr>
      </tbody>
    </table>
  </div>
              ...
              <table summary="List of threads" cellpadding="0" cellspacing="0" width="100%">
                ...
                %>
                  <tr class="jive-even">
                    ...
                    <td class="jive-author" nowrap="nowrap" width="1%"><span class=""> <a href="login.jsp">zhangyue</a> </span></td>
                    ...
                    <td class="jive-last" nowrap="nowrap" width="1%"><div class="jive-last-post"> <%=new java.text.SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(a.getPdate()) %> <br>
                        by: <a href="article.jsp" title="jingjiangjun" style="">zhangyue&#187;</a> </div></td>
                  </tr>
